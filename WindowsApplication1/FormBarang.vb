...
Public Class FormBarang
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Else
                Call Connection()
                Dim InputData As String = "Insert Into tbl_barang values ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "')"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Else
            ...
            Else
                Call Connection()
                Dim UpdateData As String = "Update tbl_barang set NamaBarang = '" & TextBox2.Text & "',harga = '" & TextBox3.Text & "',satuan = '" & TextBox4.Text & "' Where KodeBarang = '" & TextBox1.Text & "'"
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        Call Connection()
        Cmd = New OdbcCommand("Select * From tbl_barang where namaBarang = '" & TextBox2.Text & "'", Conn)
        Rd = Cmd.ExecuteReader
        Rd.Read()
        If Not Rd.HasRows Then
